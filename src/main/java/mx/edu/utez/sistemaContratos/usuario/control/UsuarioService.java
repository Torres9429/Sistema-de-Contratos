...
public class UsuarioService {
    ...
    @Autowired
    public UsuarioService(UsuarioRepository repository, EmailSender emailSender) {
...
/*
    ...
    public ResponseEntity<Object> sendCorreo(UsuarioDto dto) {
       ...
       // if(usuario == null){
        ...
        //}
        correoSender.sendSimpleMessage("rocitorres48@gmail.com",
                ...
                "<!DOCTYPE html>\n" +
                        ...
                        "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin: 0; word-break: break-word;\"><span style=\"word-break: break-word; color: #aa67cf;\">"+2314+"</span></p>\n" +
                        "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n" +
                        "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\n" +
                        "\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\n" +
                        "\t\t\t\t\t\t\t\t\t\t\t\t\t</table>\n" +
...
*/
    ...
    public ResponseEntity registrarUsuario(UsuarioDto dto) {
        ...
        Usuario usuario = new Usuario(dto.getNombre(), dto.getApellidos(), dto.getCorreo(), dto.getTelefono(), true);
        usuario = repository.saveAndFlush(usuario);

        return new ResponseEntity<Message>(new Message(usuario, "Usuario registrado correctamente", TypesResponse.SUCCESS),HttpStatus.OK);
    }
